...
void badFunction() { TARDIGRADE_ERROR_TOOLS_CATCH(throw std::logic_error("oops")); }

void containsBadFunction() { TARDIGRADE_ERROR_TOOLS_CATCH(badFunction()); }

void goodFunction() { return; }

tardigradeErrorTools::Node *goodNodeFunction() { return NULL; }

tardigradeErrorTools::Node *badNodeFunction() { return new tardigradeErrorTools::Node(__func__, "oops"); }
...
void runCheck(const bool condition){TARDIGRADE_ERROR_TOOLS_CHECK(condition, "mymessage")}
